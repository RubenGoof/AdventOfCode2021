...
while eof(#in2) = 0
    ...
    if firstX <> secondX and firstY <> secondY then goto [FinishRound]
    ...
    for x = firstX to secondX step stepSizeX
        'For now we assume that if this code runs, firstY=secondY
    ...
    for y = firstY to secondY step stepSizeY
        'For now we assume that if this code runs, firstX=secondX
